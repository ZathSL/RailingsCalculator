...
def calcola_distanze_sx_muro_acuti(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
    ...
    return Misure_segmento(new_segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_muro, n_acciaio,
                           ...
                           distanza_lato_busoni_alluminio, True, False)

# TODO: Caso 1 - angolo sx = 90 AND angolo dx = 90
def calcola_distanze_sx_muro_retti(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                   n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
...
# TODO: Caso 1 - angolo sx > 90 AND angolo dx > 90
def calcola_distanze_sx_muro_ottusi(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                    n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
...
# TODO: Caso 1 - angolo sx < 90 AND angolo dx = 90
def calcola_distanze_sx_muro_sx_acuto_dx_retto(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                               n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
    new_segmento = Segmento(segmento.id, l_esterna, segmento.spessore_sbarra, segmento.angolo_sx,
                            segmento.angolo_dx, segmento.l_busone_acciaio, segmento.l_busone_alluminio,
...
# TODO: Caso 1 - angolo sx < 90 AND angolo dx > 90
def calcola_distanze_sx_muro_sx_acuto_dx_ottuso(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                                n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
    new_segmento = Segmento(segmento.id, l_esterna, segmento.spessore_sbarra, segmento.angolo_sx,
                            segmento.angolo_dx, segmento.l_busone_acciaio, segmento.l_busone_alluminio,
...
# TODO: Caso 1 - angolo sx = 90 AND angolo dx > 90
def calcola_distanze_sx_muro_sx_retto_dx_ottuso(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                                n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
    new_segmento = Segmento(segmento.id, l_esterna, segmento.spessore_sbarra, segmento.angolo_sx,
                            segmento.angolo_dx, segmento.l_busone_acciaio, segmento.l_busone_alluminio,
...
# TODO: Caso 1 - angolo sx = 90 AND angolo dx < 90
def calcola_distanze_sx_muro_sx_retto_dx_acuto(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                               n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
    new_segmento = Segmento(segmento.id, l_esterna, segmento.spessore_sbarra, segmento.angolo_sx,
                            segmento.angolo_dx, segmento.l_busone_acciaio, segmento.l_busone_alluminio,
...
# TODO: Caso 1 - angolo sx > 90 AND angolo dx = 90
def calcola_distanze_sx_muro_sx_ottuso_dx_retto(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                                n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
    new_segmento = Segmento(segmento.id, l_esterna, segmento.spessore_sbarra, segmento.angolo_sx,
                            segmento.angolo_dx, segmento.l_busone_acciaio, segmento.l_busone_alluminio,
...
# TODO: Caso 1 - angolo sx > 90 AND angolo dx < 90
def calcola_distanze_sx_muro_sx_ottuso_dx_acuto(l_muro, distanza_muro, segmento, id_misura, distanza_fine_sbarra_lato_busone, distanza_minima,
                                                n_busoni_acciaio, n_busoni_alluminio, n_max_busoni_acciaio, n_min_busoni_alluminio):
    l_esterna = l_muro - distanza_muro
    new_segmento = Segmento(segmento.id, l_esterna, segmento.spessore_sbarra, segmento.angolo_sx,
                            segmento.angolo_dx, segmento.l_busone_acciaio, segmento.l_busone_alluminio,
